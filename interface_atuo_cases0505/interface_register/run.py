...
import interface_atuo_cases0505.public.writeExcel
from interface_atuo_cases0505.public import Unit_test
from interface_atuo_cases0505.public.logger import Log
from interface_atuo_cases0505.public.smtp import massageMail
...
t = interface_atuo_cases0505.public.writeExcel.writeExcel(
...
file = open('python5' + now +'.html', "wb+")
runner1 = HTMLTestRunner(stream=file, verbosity=2, title='python TextReport', description='现在应该萌萌哒')
runner.run(suite)
