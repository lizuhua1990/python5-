...
class LoginPage(BasePage):
    ...
    def login(self,url,username,passed):
        self.driver.get(url)
        self.get_element(self.login_username_xpath).send_keys(username)
        self.get_element(self.login_passwd_xpath).send_keys(passed)
        self.get_element(self.login_button_xpath).click()
